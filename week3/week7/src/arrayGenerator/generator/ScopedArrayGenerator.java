 ...
 *
 * Implementing classes must provide methods for checking whether a value is within the arrayGenerator.scope,
 * a method returning a random element within the arrayGenerator.scope, and a method returning the size of the
 * arrayGenerator.scope.
 *
...
public abstract class ScopedArrayGenerator<T> implements ArrayGenerator<T> {
    ...
    private Scope<T> scope; // the arrayGenerator.scope of this generator
     ...
     * @return an array of the required size, containing values within this arrayGenerator.scope
     */
    abstract T[] createArray(int size);

    /**
     * Generate an array of random values (within this generator's arrayGenerator.scope).
     *
     * @param size the size of the array to be generated.
     * @return an array of the required size, containing random values from within the
     * permitted arrayGenerator.scope.
     *
