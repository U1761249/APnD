...
public class AdjacencyGraph<T> implements Graph<T>
{
    ...
    public void add(T start, T end) throws GraphError {
        if (contains(start,end)) {
            ...
            throw new GraphError("Cannot add " + start + "==>" + end + " to the graph.  One or both of the nodes on this edge are not in the graph.");
        } else {
    ...
    public Hashtable<T, Set<T>> getGraph(){return adjacencyList;}
